...
class CameraOperation:
    ...
    def Work_thread(self, winHandle):
        ...
        while True:
            ...
            numArray = Color_numpy(self.buf_grab_image,self.st_frame_info.nWidth,self.st_frame_info.nHeight)
            RGB_img = cv2.cvtColor(numArray, cv2.COLOR_BGR2RGB)
            cv2.imshow("Hihi",RGB_img)
            cv2.waitKey(1)
